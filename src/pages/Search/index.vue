                  ...
                  <li :class="{ active: isOne }" @click="changeOrder('1')">
                    <a
                      >综合<span
                        v-show="isOne"
                        class="iconfont"
                        :class="isAsc ? 'icon-jiang1' : 'icon-jiang'"
                      ></span
                    ></a>
                  </li>
                  <li :class="{ active: isTwo }" @click="changeOrder('2')">
                    <a
                      >价格<span
                        v-show="isTwo"
                        class="iconfont"
                        :class="{ 'icon-jiang1': isAsc, 'icon-jiang': isDesc }"
                      ></span
                    ></a>
                  </li>
                </ul>
...
export default {
  ...
  beforeMount() {
    ...
    Object.assign(this.searchParams, this.$route.query, this.$route.params); //query和params的参数赋值给searchParams
  },
  mounted() {
  ...
  computed: {
    ...
    ...mapGetters(["goodsList"]), //getter 传数组
    isOne() {
      return this.searchParams.order.indexOf("1") != -1; //1 综合
    },
    isTwo() {
      return this.searchParams.order.indexOf("2") != -1; //2 价格
    },
    isAsc() {
  ...
  methods: {
    ...
    removeCategoryName() {
      ...
      //但是你把相应的字段变为undefined，当前这个字段不会带给服务器，性能优化了
    ...
    changeOrder(flag) {
      ...
      let orginsFlag = originOrder.split(":")[0]; // 0 1
      let originSort = originOrder.split(":")[1]; // asc desc
      //新的排序方式
      let newOrder = "";
      //判断的是多次点击的是不是同一个按钮
      if (flag == orginsFlag) {
