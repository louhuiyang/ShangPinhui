        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="sale in spuSaleAttrList" :key="sale.id">
                ...
                <dd
                  ...
                  :key="saleValue.id"
                  @click="changeActive(saleValue, sale.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a
                  href="javascript:"
                  class="mins"
                  @click="goodsNum > 1 ? goodsNum-- : (goodsNum = 1)"
                  >-</a
                >
              </div>
              <div class="add">
...
export default {
  ...
  methods: {
    changeActive(saleValue, arr) {
      // console.log(saleValue, arr); 当前点击的 整个数组
      arr.forEach((el) => {
        //排他
        el.isChecked = 0;
      });
    ...
    changeGoodsNum(event) {
      //用户输入进来的文本 * 1
      let value = event.target.value * 1; //非数字*1==NaN
      console.log(value);
